                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-3 col-3 order-1">
                            <div class="logo_container">
                                <div class="logo"><a href="{{ url('/') }}">Bookstore</a></div>
                            </div>
                        </div>
                            ...
                            <div class="footer_column footer_contact">
                                ...
                                <div class="footer_social">
                                    <ul>
                                        ...
                                        <li><a href="{{ $setting->instagram }}"><i class="fab fa-google"></i></a>
                                        </li>
                        ...
                        <div class="col">
                            ...
                            <div
                                ...
                                <div class="copyright_content">
                                    ...
                                    </script> All rights reserved | Lê Hồng Chiến <i
                                        class="fa fa-heart" aria-hidden="true"></i> by <a
                                        href="https://www.facebook.com/profile.php?id=100025951390410"
                                        target="_blank">HCl</a>
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                </div>
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('order.tracking') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="status_code" required="" class="form-control"

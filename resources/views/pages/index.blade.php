                                         ...
                                         <div class="deals_content">
                                             <div class="deals_info_line d-flex flex-row justify-content-start">
                                                 <div class="deals_item_category"><a
                                                         href="#">{{ $item->brand_name }}</a></div>

                                                 @if ($item->discount_price == null)
                                                 @else
                                                     <div class="deals_item_price_a ml-auto">${{ $item->selling_price }}
                                                     </div>
                                                 @endif
                                             ...
                                             <div class="deals_info_line d-flex flex-row justify-content-start">
                                                 ...
                                                 @if ($item->discount_price != null)
                                                     <div class="deals_item_price ml-auto">${{ $item->discount_price }}
                                                     </div>
                                                 @else
                                                 @endif
                                         ...
                                         <div class="featured_slider_item">
                                             ...
                                             <div
                                                 ...
                                                 <div
                                                     ...
                                                     <img src="{{ asset($item->image_one) }}" width="120" height="140"
                                                         alt=""></div>
                                                 <div class="product_content">
                                                     @if ($item->discount_price == null)
                                                         <div class="product_price discount">${{ $item->selling_price }}
                                                         </div>
                                                     @else
                                                     ...
                                                     <div class="product_extras">
                                                         ...
                                                         <button id="{{ $item->id }}"
                                                             class="product_cart_button add_to_cart" data-toggle="modal"
                                     ...
                                     @foreach ($trend as $item)
                                         ...
                                         <div class="featured_slider_item">
                                             ...
                                             <div
                                                 ...
                                                 <div
                                                     class="product_image d-flex flex-column align-items-center justify-content-center">
                                                     <img src="{{ asset($item->image_one) }}" width="120"
                                                         height="140" alt=""></div>
                                                 <div class="product_content">
                                                     @if ($item->discount_price == null)
                                                         <div class="product_price discount">${{ $item->selling_price }}
                                 ...
                                 <div class="row fill_height">
                                     ...
                                     <div class="col-lg-8 col-md-6 fill_height">
                                         <div class="banner_2_image_container">
                                             <div class="banner_2_image"><img src="{{ asset($item->image_one) }}"
                                                     height="500" width="200" alt=""></div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                                             ...
                                             <div class="featured_slider_item">
                                                 ...
                                                 <div
                                                     ...
                                                     <div class="product_content">
                                                         ...
                                                         <div class="product_name">
                                                             <div><a href="product.html">{{ $item->product_name }}</a>
                                                             </div>
                                                         </div>
                                                         <div class="product_extras">
                                                             <div class="product_color">
                                         ...
                                         <div class="trends_content">
                                             ...
                                             <div class="trends_info clearfix">
                                                 <div class="trends_name"><a
                                                         href="product.html">{{ $item->product_name }}</a></div>

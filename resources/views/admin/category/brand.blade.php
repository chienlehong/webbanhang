            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.brand.edit' , $row->id) }} " class="btn btn-sm btn-info">Edit</a>
                    <a href="{{ route('admin.brand.delete' , $row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>

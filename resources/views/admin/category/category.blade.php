            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.edit.category' , $row->id) }} " class="btn btn-sm btn-info">Edit</a>
                    <a href="{{ route('admin.delete.category' , $row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>

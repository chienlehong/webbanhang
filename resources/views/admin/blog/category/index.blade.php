            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Category Name Vn</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('edit.blogcategory' , $row->id) }}" class="btn btn-sm btn-info">Edit</a>
       ...
       <form method="post" action="{{ route('store.blog.category') }}">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Vietnam" name="category_name_in">
